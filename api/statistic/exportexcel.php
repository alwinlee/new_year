<?php
    ...
    if ($groupkey=="*"){
        $table_title=$currY."朝禮法會 義工名冊(總)";        
    }else if ($groupkey=="1"){
        $table_title=$currY."朝禮法會 義工名冊(秘書大組)";$group="秘書大組";
    }else if ($groupkey=="2"){
        $table_title=$currY."朝禮法會 義工名冊(教育大組)";$group="教育大組";
    }else if ($groupkey=="3"){
        $table_title=$currY."朝禮法會 義工名冊(庶務大組)";$group="庶務大組";
    }else if ($groupkey=="4"){
        $table_title=$currY."朝禮法會 義工名冊(總務大組)";$group="總務大組";
    }else if ($groupkey=="5"){
        $table_title=$currY."朝禮法會 義工名冊(善法實踐)";$group="善法實踐";
    }
