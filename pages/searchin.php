...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-10" align="center">
                    ...
                    <div class="input-group  has-error"><!---->
                        ...
                        <span class="input-group-addon" id="basic-lblclsserialex">或其他身份</span>
                        <select class="form-control" id="basic-clsserialex" disabled readonly>
                            <option value='0'>-</option>
                        </select>
                    </div>
                    <hr>
                    ...
                    <div class="input-group  has-error">
                        <span class="input-group-addon" id="basic-lblgroup">參加日期 ： </span>
                            <div class="input-group-btn" style="width:19%">
                                ...
                                <input type="checkbox" class="form-control sx-checkbox" id="basic-join1" disabled readonly>
                            </div>
                            <div class="input-group-btn" style="width:8%">
                                ...
                                <input type="checkbox" class="form-control sx-checkbox" id="basic-live1" disabled readonly>
                            </div>
                            <div class="input-group-btn" style="width:19%">
                                <input type="text" style="text-align: center;" class="form-control" id="basic-d2" value="01.30(一)初三" readonly>
                                <input type="checkbox" class="form-control sx-checkbox" id="basic-join2" disabled readonly>
                            </div>
                            <div class="input-group-btn" style="width:8%">
                                <input type="text" style="text-align: center;" class="form-control" id="basic-d2" value="住宿" readonly>
                                <input type="checkbox" class="form-control sx-checkbox" id="basic-live2" disabled readonly>
                            </div>
                            <div class="input-group-btn" style="width:19%">
                                <input type="text" style="text-align: center;" class="form-control" id="basic-d2" value="01.31(二)初四" readonly>
                                <input type="checkbox" class="form-control sx-checkbox" id="basic-join3" disabled readonly>
                            </div>
                            <div class="input-group-btn" style="width:8%">
                                <input type="text" style="text-align: center;" class="form-control" id="basic-d2" value="住宿" readonly>
                                <input type="checkbox" class="form-control sx-checkbox" id="basic-live3" disabled readonly>
                            </div>
                            <div class="input-group-btn" style="width:19%">
                                <input type="text" style="text-align: center;" class="form-control" id="basic-d2" value="02.01(三)初五" readonly>
                                <input type="checkbox" class="form-control sx-checkbox" id="basic-join4" disabled readonly>
                            </div>
                    </div>
                    <div class="input-group  has-success">
                    ...
                    <div class="input-group  has-success">
                        <span class="input-group-addon" id="basic-lblgroup">前行打掃 ： </span>
                             <div class="input-group-btn" style="width:30%">
                                <input type="text" style="text-align: center;" class="form-control" id="basic-lbljoinclean1" value="01/21(六) 08:30~14:00" readonly>
                            ...
                            <div class="input-group-btn" style="width:70%">
                                ...
                                <input type="text" class="form-control" id="basic-joincleantraffic" placeholder="範例：AC (未填則為自行往返)" disabled readonly>
                            </div>
                    </div>
                    <div class="input-group  has-success">
    ...
    <script src="../resource/js/api.js?{CED65810-7F03-4706-A4AD-89213E541932}"></script>
    <script src="../resource/js/searchin.js?{CED65810-7F03-4706-A4AD-89213E541932}" type="text/javascript" charset="utf-8"></script>
</body>
